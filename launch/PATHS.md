...
7b. **`--vs auto` (CLI only, tip 0.1.19+):** `node bin/forcepush-ghost.js upstream/repo --vs auto` — capped public-fork pick that still holds tip SHA; find none → EXIT 2; never invent dual-hit; Pages never auto live
