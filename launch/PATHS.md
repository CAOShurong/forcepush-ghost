# Launch install paths (v0.1.19)

1. **Primary — Pages demo:** https://caoshurong.github.io/forcepush-ghost/demo/
2. **Secondary — GitHub Release:** https://github.com/CAOShurong/forcepush-ghost/releases/tag/v0.1.19
...
**Release pin:** [v0.1.19](https://github.com/CAOShurong/forcepush-ghost/releases/tag/v0.1.19) @ `--vs auto` public fork tip-SHA hold. Pages / `npx github:…` follow `main`. **Do not pin ephemeral tip SHAs.**
