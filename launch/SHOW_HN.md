...
**CLI honesty (optional follow-up only):** live/`--vs` hard-timeout ~60s → EXIT 2; never invent timeline rows. Package tip is 0.1.18 pending Dist Release cut. **HOLD — do not post.**
