# npm publish checklist — forcepush-ghost@0.1.4
...
- [ ] `package.json` version is `0.1.4` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.4
npx --yes forcepush-ghost@0.1.4 --fixture scandal-a
```

## Then
- Star PM: tag/Release `v0.1.4` notes already point at Pages demo as zero-install
