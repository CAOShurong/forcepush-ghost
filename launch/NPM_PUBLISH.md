# npm publish checklist — forcepush-ghost@0.1.12
...
- [ ] `package.json` version is `0.1.12` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.12
npx --yes forcepush-ghost@0.1.12 --fixture scandal-a
```
