# npm publish checklist — forcepush-ghost@0.1.16
...
- [ ] `package.json` version is `0.1.16` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.16
# Path B primary (fork-witness):
npx --yes forcepush-ghost@0.1.16 --fixture fork-witness-a
# classic Path A still available:
npx --yes forcepush-ghost@0.1.16 --fixture scandal-a
```
