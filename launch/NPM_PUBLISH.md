# npm publish checklist — forcepush-ghost@0.1.9
...
- [ ] `package.json` version is `0.1.9` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.9
npx --yes forcepush-ghost@0.1.9 --fixture scandal-a
```
