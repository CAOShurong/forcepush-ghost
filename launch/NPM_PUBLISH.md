# npm publish checklist — forcepush-ghost@0.1.10
...
- [ ] `package.json` version is `0.1.10` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.10
npx --yes forcepush-ghost@0.1.10 --fixture scandal-a
```
