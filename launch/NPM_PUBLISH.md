# npm publish checklist — forcepush-ghost@0.1.11
...
- [ ] `package.json` version is `0.1.11` (do not rewrite older tags)
...
## Post-publish verify
```bash
npm view forcepush-ghost version   # expect 0.1.11
npx --yes forcepush-ghost@0.1.11 --fixture scandal-a
```
