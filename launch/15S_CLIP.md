...
**Release v0.1.19** (AbortSignal timeout + Activity-honesty + github one-liner): Path B (fork-witness hook) is the default Pages share/OG/hero; Path A remains classic Scandal fixtures.
...
## Path B — Fork-witness A (default @ Release v0.1.19 / Pages Path B)
| t | shot | overlay |
|---|---|---|
| 0–2s | Hero **`fork-witness.gif`** (FW-A already selected) | Upstream wiped it. The fork still remembers… |
| 2–6s | Dual-rail / fw-preview (no need to click Play first) | offline dual-rail |
